...
CARDS_SPEC = [
    ("c1_1", "table", "ダニー・サバテロ", [("生年月日", "1993.3.31", "33歳／米イリノイ州出身"), ("所属", "ATT", "アメリカン・トップチーム／175cm"), ("戦績", "19勝4敗1分", "KO5・一本5・判定9／RIZIN 5戦5勝")], "Sherdog／RIZIN公式サイト"),
    ...
    ("c9_4", "table", "Bellator 289 暫定王座戦 判定（2022.12.9）", [("クロスビー", "50-45", "サバテロ"), ("コロン", "48-47", "ストッツ"), ("マイナー", "48-47", "ストッツ")], "Bellator MMA 公式中継"),
    ...
    ("c16_6", "table", "サバテロが誇る記録", [("試合拒否・欠場", "0", "一度もない"), ("計量失敗", "0", ""), ("薬物陽性", "0", "")], "RIZIN公式インタビュー（2026年3月）"),
    ("c18_2", "table", "RIZIN.55 バンタム級（2026.11.8）", [("鹿志村仁之介", "太田忍", "61.0kg"), ("福田龍彌", "キム・スーチョル", "61.0kg"), ("王者サバテロ", "次戦未定", "大晦日が濃厚")], "RIZIN公式サイト（対戦カード）"),
]
