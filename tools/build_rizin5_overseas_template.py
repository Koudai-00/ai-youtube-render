...
DISP = {
    ...
    "ユーエフシー": "UFC", "エムエムエージャンキー": "MMA Junkie", "エムエムエーアカウント": "MMAアカウント",
    "ミックスドマーシャルアーツ": "MMA", "エムエムエー": "MMA", "エムブイピープロモーションズ": "MVP Promotions",
    "アンクラウンド": "Uncrowned", "シャードッグ": "Sherdog", "アンドニュー": "AND NEW",
    "チャンピオンシップラウンズ": "Championship Rounds", "ホームオブファイト": "Home of Fight",
    "コンバットスポーツトゥデイ": "Combat Sports Today", "モーニングコンバット": "Morning Kombat",
    "アリエルヘルワニ": "アリエル・ヘルワニ", "ルークトーマス": "ルーク・トーマス",
    "ジェイクポール": "ジェイク・ポール", "アレクサンダーボルカノフスキー": "アレクサンダー・ボルカノフスキー",
...
# ---- 章タグ ----
CHAP_LABEL = {
    "ch1": ("海外メディアは何と報じたか", "MMA Junkie / Uncrowned / PFL / Sherdog"),
    "ch2": ("試合内容への評価", "支配的だったのか、それとも"),
    "ch3": ("契約とUFC論", "MVP・PFLと2年契約"),
    "close": ("まとめ", "日本のリングで評価が変わった一夜"),
}
...
CARDS_SPEC = [
    ...
    ("c2n", "media", "海外のMMA解説クリエイター", "McKee talked like he was the best 145er on the planet. Shaydullaev treated him like a sparring partner, slammed him, and walked out with two belts.", "海外のポスト（要旨）"),
    ("c3b", "media", "アリエル・ヘルワニ", "Shaydullaev has signed a two-year deal with MVP and the PFL, beginning January 2027.", "スクープ報道／22万回超の表示"),
    ("c3e", "media", "海外のファン", "二冠を取ったのに、トポリアやエヴロエフではなくジェイク・ポールの金を取るのか。", "海外のポスト（匿名）"),
    ("c3g", "media", "海外のファン", "UFCがプライドを捨ててクロスプロモーションしてくれないのは残念だ。ボルカノフスキー vs シェイドゥラエフを見てみたい。", "海外のポスト（匿名）"),
    ("e1", "media", "ラジャブアリ・シェイドゥラエフ", "AJ・マッキーは非常にフィジカルが強く優れたファイター。打撃も組みも強かった。ただ私の方が強かったということだと思う。", "RIZIN公式 試合後インタビューより"),
    ("e2", "media", "ラジャブアリ・シェイドゥラエフ", "AJ・マッキーはフェザー級で世界最強のファイターの1人。3ラウンドフルで戦うことを想定してトレーニングしてきた。", "RIZIN公式 試合後インタビューより"),
]
...
<body>
  <div id="root" data-composition-id="rizin5-overseas" data-start="0" data-duration="{WIN}" data-width="1920" data-height="1080">
{J(bg_divs,"    ")}
...
{J(sub_tws)}
      ...
      window.__timelines['rizin5-overseas'] = tl;
    </script>
  </div>
</body>
</html>
