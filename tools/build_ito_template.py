...
TPL = ROOT / "hyperframes" / "templates" / "ito"
TIM = json.load(open(ROOT / "subtitles" / "out" / "ito" / "timings.json", encoding="utf-8"))
...
DISP = {
    ...
    "ねっくす": "NEXUS", "ノックアウト": "KO",
    "いとう": "伊藤", "うぉーずまん": "ウォーズマン", "ぎゃんぶらー": "ギャンブラー",
}
def disp(t):
...
# ===== 冒頭タイトル(0.3〜10.5) =====
TITLE = [("対外国人 無敗のKO王", 0.9, "y"), ("尾張のウォーズマン", 1.5, "r")]
...
bg_divs.append('<div class="bgseg" id="bgmain" style="z-index:1;opacity:1">'
               f'<video id="bgmain-v" src="assets/bgvid/ito_bg_w{_wi}.mp4" muted playsinline '
...
<html><head><meta charset="utf-8"><style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box;}}
  ...
  <div id="root" data-composition-id="ito" data-start="0" data-duration="{WIN}" data-width="1920" data-height="1080">
{J(bg_divs,"    ")}
    {AUDIO_BLOCK}
{J(chap_audio,"    ")}
    <div class="veil"></div>
