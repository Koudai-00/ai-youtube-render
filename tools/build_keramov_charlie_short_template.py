...
"""ケラモフ減量×チャーリー柏木 ショート テンプレ生成(縦1080x1920)。
   背景=事前結合した単一動画(keramov_bg_full.mp4)。
...
THUMB_END = B["h1"]["start"]      # サムネ区間の終わり=最初のナレビートの開始
...
DISP = [("スーパーライジンファイブ", "超RIZIN.5"), ("チャーリーかしわぎ", "チャーリー柏木"),
        ("ライジン", "RIZIN"), ("かしわぎ", "柏木"),
        ("いってんななキロ", "1.7kg"), ("ごひゃくグラム", "500g"), ("にひゃくグラム", "200g"),
        ("ろくじゅうろくキロ", "66.0kg"), ("なんびゃくにん", "何百人"),
        ("たいじゅうちょうか", "体重超過"), ("おとこぎ", "男気"),
        ("メルビンギラード", "メルビン・ギラード")]
...
KWCOL = [("チャーリー柏木", "r"), ("柏木", "r"), ("ケラモフ", "r"),
         ("超RIZIN.5", "b"), ("RIZIN", "b"), ("マッチメイカー", "b"),
         ("キャッチウェイト", "y"), ("激怒", "y"), ("サウナ", "y"), ("減量", "y"),
         ("1.7kg", "y"), ("500g", "y"), ("200g", "y"), ("66.0kg", "y"),
         ("心が折れ", "y"), ("やる気", "y"), ("クリア", "y"), ("何百人", "y")]
...
bg_div = ('<div class="bgv" id="bg" style="opacity:1">'
          '<video id="bg-v" src="assets/bgvid/keramov_bg_full.mp4" muted playsinline '
...
<html><head><meta charset="utf-8"><style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box;}}
  ...
  <div id="root" data-composition-id="keramov-charlie-short" data-start="0" data-duration="{WIN:.2f}" data-width="1080" data-height="1920">
    {bg_div}
    {narr_tag}
    {bgm_tag}
...
{chr(10).join('      ' + x for x in tl)}
      ...
      window.__timelines['keramov-charlie-short'] = tl;
    </script>
  </div>
</body></html>"""
